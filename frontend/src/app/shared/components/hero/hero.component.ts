          ...
          <div class="w-full max-w-sm mt-4 animate-slide-up" *ngIf="isLoggedIn">
            <div class="flex gap-4 justify-center">
              <a
                ...
                class="bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-md shadow-lg flex items-center gap-2 font-semibold transition-all duration-300"
              >
              ...
              <a
                ...
                class="border-2 border-orange-600 text-orange-600 hover:text-orange-800 hover:border-orange-800 px-4 py-2 rounded-md flex items-center gap-2 font-semibold transition-all duration-300"
              >
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" />
                </svg>
