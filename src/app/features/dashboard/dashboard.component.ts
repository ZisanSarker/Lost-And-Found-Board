...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule, ProfileSidebarComponent],
  template: `
        ...
        <div class="lg:col-span-1">
          ...
          <div class="space-y-2">
            <button 
              ...
              class="w-full flex items-center justify-start px-4 py-2 rounded-lg transition-all duration-300"
            >
              <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button 
              ...
              class="w-full flex items-center justify-between px-4 py-2 rounded-lg transition-all duration-300"
            >
              ...
              <span *ngIf="getUnreadMessagesCount() > 0" class="bg-red-600 text-white text-xs px-2 py-1 rounded-full">
            ...
            >
              <div class="flex items-center">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-5 5v-5zM9 3a6 6 0 016 6v7l2 2H5l2-2V9a6 6 0 016-6z"></path>
                </svg>
                Notifications
              </div>
              <span *ngIf="getUnreadNotificationsCount() > 0" class="bg-red-600 text-white text-xs px-2 py-1 rounded-full">
